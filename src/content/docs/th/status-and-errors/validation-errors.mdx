...
>
> แหล่งอ้างอิง: [Stripe API — errors](https://docs.stripe.com/api/errors), [GitHub REST API errors](https://docs.github.com/en/rest/overview/troubleshooting)
...
export const quiz = [
  ...
  },
  {
    ...
    options: [
      'เร็วกว่าสำหรับฝั่ง server',
      'ช่วยให้ user ไม่ต้องวนลูป submit-fix-submit ที่น่าหงุดหงิด',
      'HTTP บังคับให้ทำ',
      'ช่วยลดจำนวน status code',
    ],
    answer: 1,
  },
  {
