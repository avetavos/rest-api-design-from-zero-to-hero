...
**ใช้ REST สำหรับ Internal Microservice ที่ต้องการ Performance**
อาการ:
...
>
> **Netflix:**
> - ใช้ gRPC สำหรับ service-to-service call ภายใน
> - ใช้ GraphQL/REST ที่ edge ซึ่งเป็นจุดที่ client และ partner traffic มาจบ
>
> แหล่งอ้างอิง: [Netflix TechBlog — Practical API Design at Netflix](https://netflixtechblog.com/practical-api-design-at-netflix-part-1-using-protobuf-fieldmask-35cfdc606518), [Netflix CNCF case study](https://www.cncf.io/case-studies/netflix/)

<Callout title="ทั้งสามแบบใช้ร่วมกันได้">
