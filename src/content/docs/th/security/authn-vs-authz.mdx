...
>
> แหล่งอ้างอิง: [GitHub REST API — troubleshooting](https://docs.github.com/en/rest/overview/troubleshooting), [AWS IAM policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html)
